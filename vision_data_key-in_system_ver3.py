    ...
    with c2:
        ...
        <script>
            ...
            const unlockSystem = () => {
                ...
                for(let b of btns) { 
                    if(b.textContent && b.textContent.includes('UNLOCK_SYSTEM_BTN_HIDDEN')) { 
                        b.click(); 
                        break; 
                    } 
                }
...
div[data-testid="stExpander"] { background-color: #ffffff !important; border: 1px solid #e2e8f0 !important; border-radius: 8px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.03) !important; }
div[data-testid="stExpander"] details summary { background-color: #0f172a !important; border-bottom: 1px solid #0f172a !important; padding: 10px 15px !important; border-radius: 8px 8px 0 0; }
...
[data-testid="stSidebarCollapseButton"] svg { display: none !important; color: transparent !important; font-size: 0px !important; }
...
# ==========================================
    ...
    top_c1, top_c2 = st.columns([4.5, 1.5])
    with top_c1:
    ...
    with top_c2:
        b1, b2 = st.columns(2)
        with b1:
            st.link_button("VIEWER", "https://vision-data-viewer-zfmhextlbuluocyrbjzquz.streamlit.app/", use_container_width=True)
        with b2:
